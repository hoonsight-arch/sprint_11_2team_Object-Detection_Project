"""
YOLO26 추론 스크립트 — submission_yolo26.csv 생성

inference_yolo.py(YOLO11)와 동일한 구조.
앙상블 전 단일 모델 성능 확인 또는 독립 제출 시 사용.

실행:
    python inference_yolo26.py
    python inference_yolo26.py --checkpoint outputs/yolo/yolo26/weights/best.pt
    python inference_yolo26.py --checkpoint outputs/yolo/yolo26/weights/best.pt --conf 0.3 --iou 0.5
"""
import argparse
import csv
import json
...
def parse_args():
    ...
    parser.add_argument("--checkpoint", default="outputs/yolo/yolo26/weights/best.pt")
...
def main():
    ...
    csv_path = pred_dir / "submission_yolo26.csv"
